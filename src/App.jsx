        ...
        <main>
          ...
          <section>
            ...
            <aside className="lg:px-[176px] lg:py-[50px] sm:px-[14px] sm:py-[24px]">
              <p className="text-[16px] tracking-[1.6px]">{t("ptext3")}</p>
            ...
            <Box className="flex flex-wrap lg:pl-[176px] lg:py-[50px] sm:px-[14px] sm:py-[24px] gap-[21px]">
              ...
              <div className="bg2 w-[390px]"><Card1 img={"src/assets/card1/Intersect (1).png"} h1={t("ptext8")} p={t("ptext9")} /></div>
              <div className="bg2 w-[390px]"><Card1 img={"src/assets/card1/Intersect (2).png"} h1={t("ptext8")} p={t("ptext9")} /></div>
              <div className="bg1 w-[390px]"><Card1 img={"src/assets/card1/Intersect (3).png"} h1={t("ptext8")} p={t("ptext9")} /></div>
              <div className="bg3 w-[390px]"><Card1 img={"src/assets/card1/Intersect (4).png"} h1={t("ptext8")} p={t("ptext9")} /></div>
            </Box>
          </section>
          ...
          <section className="lg:pt-[128px] sm:py-[60px]">
            ...
            <aside className="lg:px-[176px] lg:py-[50px] sm:px-[14px] sm:py-[24px]">
              ...
              <h1 className="lg:text-[60px] sm:text-[39px] uppercase">{t("ptext10")} <p><span className="text-[#6DDCFF]">{t("ptext11")}</span> {t("ptext12")}</p></h1>
            ...
            <Box className="flex justify-between">
              <aside className="relative">
                <aside className="lg:px-[176px] lg:py-[50px] sm:pl-[10px] sm:py-[24px]">
                  <h1 className="lg:text-[60px] sm:text-[32px] uppercase">{t("pt3")} </h1>
                  <h1 className="lg:text-[60px] sm:text-[32px] uppercase">{t("pt31")} <span className="text-[#6DDCFF] lg:text-[60px] sm:text-[39px] uppercase">{t("pt4")}</span></h1>
                  <p className="text-[#6DDCFF] lg:text-[60px] sm:text-[32px] uppercase">{t("v41")} <span className="lg:text-[60px] text-[#b8b7b7] sm:text-[39px] uppercase">{t("pt5")}</span></p>
                  <Box className="flex w-[390px] items-center gap-[10px] py-[17px] px-[16px] mt-[30px]" id="d1">
                    <h1 className="text-[24px] font-[800]">14</h1>
                    <input type="text" className="rounded-[60px] bg-[#80808000] w-[385px] px-[5px]" placeholder={t("pt6")} />
                  </Box>
                </aside>
              </aside>
          ...
          <section className="lg:py-[180px] lg:px-[176px]">
            ...
            <aside className="sm:px-[14px] sm:py-[24px]">
              <p className="text-[16px] tracking-[1.6px]">{t("pt8")}</p>
              <span className="text-[#6DDCFF] lg:text-[60px] sm:text-[39px] uppercase">{t("pt9")}</span>
              <p className="lg:text-[60px] sm:text-[39px] uppercase">{t("pt10")}</p>
            </aside>

            <Box className="lg:flex items-center gap-[14px] sm:hidden">
              <Card4 img={"src/assets/card4/Mask group (6).png"} p={t("pt11")} />
              <Card4 img={"src/assets/card4/Mask group (6).png"} p={t("pt11")} />
              <Card4 img={"src/assets/card4/Mask group (6).png"} p={t("pt11")} />
              <Card4 img={"src/assets/card4/Mask group (6).png"} p={t("pt11")} />
            </Box>
          ...
          <section className="lg:px-[176px] lg:pb-[100px]">
            ...
            <p className="lg:text-[60px] sm:text-[39px] uppercase sm:px-[15px]">{t("pt12")}</p>
          ...
          <section className="sec lg:py-[72px] lg:px-[126px] lg:pb-[127px] sm:px-[12px] sm:py-[30px] sm:mt-[50px]">
            ...
            <Box className="flex py-[29px] justify-between items-end sm:flex-wrap">
              <aside>
                <h1 className="lg:text-[60px]  sm:text-[32px] uppercase">{t("ptxt1")}</h1>
                <h1 className="lg:text-[60px]  sm:text-[32px] uppercase">{t("ptxt2")}</h1>
                <p className="lg:w-[420px] text-[#F5F5F5]">{t("ptext3")}</p>
              </aside>
              <aside>
                <div className="form p-[25px] lg:w-[515px] md:w-[515px] flex flex-col items-start gap-[35px]">
                  <div className="flex flex-col items-center gap-[15px]">
                    <input type="text" placeholder={t("ptxt4")} className="rounded-[7px] border-[1px] py-[5px] pl-[15px] lg:pr-[200px] bg-[#ff000000] border-[#FFF] opacity-[0.2]" />
                    <input type="text" placeholder={t("ptxt5")} className="rounded-[7px] border-[1px] py-[5px] pl-[15px] lg:pr-[200px] bg-[#ff000000] border-[#FFF] opacity-[0.2]" />
                    <input type="text" placeholder={t("ptxt6")} className="rounded-[7px] border-[1px] py-[5px] pl-[15px] lg:pr-[200px] bg-[#ff000000] border-[#FFF] opacity-[0.2]" />
                  </div>
                  <div className="flex flex-col gap-[10px] items-start">
                    <p className="lg:w-[300px]">{t("ptxt7")}</p>
                    <button className="border-[1px] bg-[#ffffff00] px-[12px] py-[10px] rounded-[15px]" >{t("ptxt8")}</button>
                  </div>
                  <div className="flex items-center gap-[20px] sm:flex-wrap">
                    <button className="bg-[#6DDCFF] px-[25px] py-[15px] rounded-[15px]" >{t("ptxt9")}</button>
                    <p className="lg:w-[230px] text-[12px]">{t("ptxt10")}</p>
                  </div>
                </div>
              </aside>
            </Box>
        ...
        <footer className="lg:py-[69px] lg:px-[159px] sm:px-[15px] sm:py-[40px]">
          ...
          <aside className="py-[45px] flex items-start lg:flex-nowrap lg:gap-[130px] sm:flex-wrap sm:gap-[20px]">
            ...
            <ul className="lg:flex sm:hidden flex-col items-start gap-[15px] text-[14px] lg:w-[199px]">
              ...
              <li className="text-[#888888]">{t("row3")}</li>
              <li className="text-[#888888]">{t("row4")}</li>
              <li className="text-[#888888]">{t("row5")}</li>
              <li className="text-[#888888]">{t("row6")}</li>
              <li className="text-[#888888]">{t("row7")}</li>
              <li className="text-[#888888]">{t("row8")}</li>
              <li className="text-[#888888]">{t("row9")}</li>
              <li className="text-[#888888]">{t("row10")}</li>
              <li className="text-[#888888]">{t("row11")}</li>
              <li className="text-[#888888]">{t("row12")}</li>
            </ul>
